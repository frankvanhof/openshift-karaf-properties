...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\org.apache.karaf.client\4.2.0.fuse-730036-redhat-00001\org.apache.karaf.client-4.2.0.fuse-730036-redhat-00001.jar
...
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\slf4j\slf4j-api\1.7.22.redhat-2\slf4j-api-1.7.22.redhat-2.jar
