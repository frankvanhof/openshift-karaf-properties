...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.core\4.2.0.fuse-730036-redhat-00001\org.apache.karaf.shell.core-4.2.0.fuse-730036-redhat-00001.jar
